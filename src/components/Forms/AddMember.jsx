                ...
                <div className="relative border border-border-subtle bg-[#0b0f19]/80 backdrop-blur-xl rounded-md overflow-hidden transition-all duration-500 hover:border-neon-green/30 group shadow-[0_0_40px_rgba(52,211,153,0.04)] hover:shadow-[0_0_50px_rgba(52,211,153,0.08)]">
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        <div className="flex justify-center mb-6">
                            <div
                                className="w-16 h-16 rounded-full border border-neon-green/30 flex items-center justify-center animate-border-glow shadow-[0_0_15px_rgba(52,211,153,0.1)]"
                                style={{ filter: "drop-shadow(0 0 8px rgba(52,211,153,0.15))" }}
                            >
                                <svg className="w-8 h-8 text-neon-green" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                        ...
                        <form onSubmit={handleSubmit(add)} className="space-y-5">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="flex gap-2 items-stretch">
                                    <input
                                        ...
                                        autoComplete="off"
                                        className="flex-1 min-w-0 h-11 bg-[#0d1117]/80 border border-[#1e2d3d] rounded-sm
                                    ...
                                    <button
                                        type="button"
                                        className="shrink-0 h-11 px-4 sm:px-5 bg-neon-green/5 border border-neon-green/30
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <select
                                    className="w-full cursor-pointer appearance-none
                                               bg-[url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22none%22%20viewBox%3D%220%200%2020%2020%22%3E%3Cpath%20stroke%3D%22%2334d399%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%20stroke-width%3D%221.5%22%20d%3D%22M6%208l4%204%204-4%22%2F%3E%3C%2Fsvg%3E')]
                                               bg-[position:right_0.75rem_center] bg-[size:1.25rem_1.25rem] bg-no-repeat
                                               pr-10 rounded-sm border border-[#1e2d3d] bg-[#0d1117]
                                               px-4 py-3 font-mono text-text-primary outline-none
                                               transition-all duration-300
                                               focus:border-neon-green focus:ring-1 focus:ring-neon-green
                                               focus:shadow-[0_0_10px_#00ff8833]"
                            ...
                            <Button
                                type="submit"
                                variant="filled"
                                className={`w-full py-3 mt-2 font-semibold tracking-widest text-base transition-all duration-300 active:scale-[0.98] ${
                                    searchData?.id === userid
                                        ? "cursor-not-allowed opacity-50 bg-[#ff5f56]/10 border-[#ff5f56]/30 text-[#ff5f56] hover:shadow-none"
