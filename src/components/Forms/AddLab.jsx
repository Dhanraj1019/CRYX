          ...
          <div className="p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit(add)} className="space-y-5">
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  className="min-h-28 w-full min-w-0 resize-y rounded-sm border border-[#1e2d3d] bg-[#0d1117] px-4 py-3 font-mono text-sm text-text-primary placeholder-[#4a5568] outline-none transition-all duration-300 focus:border-neon-green focus:ring-1 focus:ring-neon-green focus:shadow-[0_0_10px_#00ff8833]"
                  id="description"
                  rows="3"
